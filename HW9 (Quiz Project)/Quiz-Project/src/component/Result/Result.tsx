...
const Result = () => {
    const { mark, numberOfQuestion } = useParams();
    console.log(mark, numberOfQuestion);
    
    const isPassed = Number(mark) >= Number(numberOfQuestion) / 2;
            ...
            <div className="result-card">
                <div className="result-card-content">
                    ...
                    <div className="score-display">
                        <h1><span className="score-value">{mark}</span>/<span className="score-total">{numberOfQuestion}</span></h1>
                    </div>
                    {isPassed ?
